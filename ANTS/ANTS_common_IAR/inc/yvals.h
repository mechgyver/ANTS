...
#define _CPPLIB_VER     312
  ...
  #define __IAR_SYSTEMS_LIB__ 4
#endif

#if (__IAR_SYSTEMS_ICC__ < 7) || (__IAR_SYSTEMS_ICC__ > 7)
...
#if 0
#pragma message("yvals.h: namespace has been enabled.")
...
#define _LOCK_STATIC_GUARD 3    /* Static once initialization */
